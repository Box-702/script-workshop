...
from ..pipeline.profiles import profile_for, profile_prompt
from ..pipeline.review import DIMENSION_LABELS, review_patch
from .state import (
    STATUS_APPLIED,
    STATUS_CONTEXTING,
    STATUS_FAILED,
...
def _parse_ops(patch_data: list[dict[str, Any]]) -> list[Any]:
    ...
    from ..pipeline.patch import PatchOp
